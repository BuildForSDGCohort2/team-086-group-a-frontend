...
import Style from "../../Styles/ContactPage/contact.module.css";
      ...
      <Container fluid>
        <Container>
          <Row className={Style.contactTop}>
            <Col>
              <p className={Style.conUs}>CONTACT US</p>
            </Col>
          </Row>
          ...
          <Row className={Style.contactTop1}>
            <p>
              ...
              repudiandae est unde qui! Perspiciatis non dicta facilis voluptate
              fuga autem dolor nemo? Mollitia!
            </p>
          </Row>
